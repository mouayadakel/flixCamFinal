...
1. **Phase 1:** Close partial gaps (files with 1–99% coverage)
...
2. **Phase 2:** 0% services by line count
   - blog-ai, bundle-recommendations, whatsapp, sms
   - promissory-note, studio-schedule, studio-testimonial
   - import-worker (821 lines)

3. **Phase 3:** Auth + policies
   - permissions.ts
   - Remaining 14 policies

4. **Phase 4:** Validators (37 at 0%)

5. **Phase 5:** Utils + stores + hooks

6. **Phase 6:** API routes by domain

7. **Phase 7:** Components by line count

8. **Phase 8:** Pages + layouts

9. **Phase 9:** Queue + workers + i18n
