...
import { Loader2, Brain, Download, Upload, CheckCircle, AlertCircle, Play, Pause, RefreshCw } from 'lucide-react'
  ...
  const approveTranslation = async (key: string, locale: string, translation: string) => {
    try {
      ...
      setTranslationKeys(prev => 
        prev.map(k => 
          k.key === key 
            ? { ...k, translations: { ...k.translations, [locale]: translation }, status: 'approved' }
            : k
        )
      )
    } catch (error) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Bulk translate content using AI assistance
          </p>
        </div>
        ...
        <TabsContent value="jobs" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure and start a new AI translation job
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="review" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review AI-generated translations before publishing
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  .map(key => (
                    <Card key={key.key} className="p-4">
                      <div className="space-y-3">
                        ...
                        <div>
                          <Label className="text-sm text-muted-foreground">Source ({sourceLocale})</Label>
                              ...
                              <div key={locale}>
                                ...
                                <Textarea
                                  ...
                                  onChange={(e) => {
                                    setTranslationKeys(prev =>
                                      prev.map(k =>
                                        k.key === key.key
                                          ? { ...k, translations: { ...k.translations, [locale]: e.target.value } }
                                          : k
                                      )
                                    )
                                  }}
                                ...
                                <div className="flex gap-2 mt-1">
                                  <Button
                                    size="sm"
                                    variant="outline"
                                    onClick={() => approveTranslation(key.key, locale, translation || '')}
                                  >
        ...
        <TabsContent value="settings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure AI translation parameters and preferences
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  AI translations require human review before publishing to ensure accuracy and cultural appropriateness.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
