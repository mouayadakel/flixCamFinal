/**
 * PUT /api/admin/shoot-types/[id]/category-flows - Bulk update category flows
 */
...
import { updateCategoryFlowsSchema } from '@/lib/validators/shoot-type.validator'
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const { flows } = updateCategoryFlowsSchema.parse(body)
    await ShootTypeService.updateCategoryFlow(id, flows)
