/**
 * GET /api/admin/studios/[id]/packages - List packages
 * POST /api/admin/studios/[id]/packages - Create package
 */
...
import { createStudioPackageSchema } from '@/lib/validators/studio-package.validator'
...
export async function GET(
  ...
  try {
    ...
    const packages = await StudioPackageService.listByStudio(id)
...
export async function POST(
  ...
  try {
    ...
    const data = createStudioPackageSchema.parse(body)
    const pkg = await StudioPackageService.create(id, data, session.user.id)
